...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("Blog Pessoal")
			.description("API do Blog Pessoal, projeto criado com o Bootcamp Generation")
			.version("1.0.0")
	...
	private static Contact contact() {
		...
		return new Contact("Tati Alves", "https://github.com/tatialveso", "tatiialveso@gmail.com");
